...
function cmpSynth(items){
  ...
  return 'This compares '+list+'. '+ideas+' Put them together and the same problem shows up from different sides: technology is never neutral, and neither is the data it learns from.';
}
