...
(function () {
  ...
  function weekPage(w, d) {
    ...
    kcOwnPool = kcOwnPool.concat((window.BFS218_KC && window.BFS218_KC[w]) || []);
    var kcItems = [], kcSeen = {};
    ...
    for (var pw = w - 1; pw >= 1 && kcItems.length < 15; pw--) {
      ...
      pool = pool.concat((window.BFS218_KC && window.BFS218_KC[pw]) || []);
      var took = 0;
    ...
    return '<div class="rise wk-grid"><section>' + hero + vid + pre + purpose + outcomes + guiding + concepts + terms + readings + watch + act + reflect + kc + navRow + '</section>' + rail + '</div>';
  }
