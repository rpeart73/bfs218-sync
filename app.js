...
(function () {
  ...
  function weekPage(w, d) {
    ...
    return '<div class="rise">' + hero + '<div class="wk-grid"><section>' + vid + pre + purpose + outcomes + guiding + programLens + concepts + terms + readings + watch + act + reflect + sg + kc + navRow + '</section>' + rail + '</div></div>';
  }
  ...
  function lensProgramSection(w, d) {
    ...
    return '<section id="wk-lens" class="node"><h2 class="wk-sec">For your program</h2>'
      + '<p style="margin:0 0 12px;font-size:.95rem;line-height:1.55;color:var(--ink-dim)">This section changes with your selected program. It turns the week\'s topic into a field diagram and a case study while keeping the same readings, activity, assessment, and outcomes for everyone.</p>'
