...
(function () {
  ...
  function weekPage(w, d) {
    ...
    return '<div class="rise">' + hero + '<div class="wk-grid"><section>' + vid + pre + purpose + outcomes + guiding + concepts + terms + readings + watch + act + reflect + sg + kc + navRow + '</section>' + rail + '</div></div>';
  }
