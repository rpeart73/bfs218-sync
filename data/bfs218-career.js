/* BFS218 Career Choices: field write-ups (byField) + grounded program notes (byProgram). */
window.BFS218_CAREER = {
 ...
 "byProgram": {
  "911 and Emergency Services Communications": "As a 911 and Emergency Services Communications student, you are training to be the calm voice that records call data, directs response, and performs under real pressure. The systems you will work beside, computer-aided dispatch, risk flags, and the police services that receive your calls, increasingly run on algorithms, and BFS218 shows how predictive policing and facial recognition have spread across Canada ahead of clear rules and fall hardest on racialized communities. The course gives you the questions to ask about the data you generate and pass along: what a risk score assumes, who it watches, and how a supposedly neutral tool can carry old bias into a life-or-death moment.",
  "Academic Upgrading": "As an Academic Upgrading student building the credits for your next program, you already know that access is never evenly shared, and this course names that same pattern in the digital world. BFS218 looks at the digital divide that leaves some communities with unreliable internet and few resources, and at predictive tools in education that can quietly steer support away from the students who most need it. You will finish with a clearer sense of how technology decides who gets seen as capable, and the confidence to question those judgments rather than accept them.",
  "Accounting": "As an Accounting student learning to prepare financial statements and apply internal control and risk management, you will work inside systems that increasingly make automated judgments about people's money. BFS218 examines how algorithms sold as objective, from credit scoring to fraud flags, can carry old inequities forward without anyone intending harm, a pattern Ruha Benjamin calls the New Jim Code. The course helps you read the data and the design behind the numbers, so you can spot where a neutral-looking financial tool is quietly treating people unequally.",
  "Asset Management": "As an Asset Management student focused on procurement, risk, sustainability, and the full life cycle of an organization's assets, you will make decisions that data models increasingly drive. BFS218 shows how risk and valuation systems that present themselves as neutral can encode inequity, and how design justice asks a different question: not only what a system optimizes, but who it serves and who bears its costs. The course gives you a sharper eye for the assumptions built into the analytics you rely on.",
  "Asset Management (Graduate Certificate)": "As an Asset Management student focused on procurement, risk, sustainability, and the full life cycle of an organization's assets, you will make decisions that data models increasingly drive. BFS218 shows how risk and valuation systems that present themselves as neutral can encode inequity, and how design justice asks a different question: not only what a system optimizes, but who it serves and who bears its costs. The course gives you a sharper eye for the assumptions built into the analytics you rely on.",
  "Aviation Operations": "As an Aviation Operations student training in flight planning, dispatch, and airside operations, you are entering an industry where borders, watchlists, and biometric screening are part of daily movement. BFS218 examines digital border technologies, the surveillance and automated decision systems documented by Petra Molnar as being tested first on migrants who have the least power to refuse, alongside facial recognition tools shown to misread darker-skinned faces far more often than lighter ones. The course helps you understand the human stakes of the screening systems that surround aviation and the people they sort.",
  "Aviation Safety": "As an Aviation Safety student developing skills in risk assessment, flight data analysis, and investigation, you will depend on data systems to tell you where danger sits. BFS218 examines how bias enters those systems through the data they are built on and the choices behind their design, and how errors in automated tools tend to land hardest on the least protected people. The course gives you the habit of asking what a dataset leaves out and who absorbs the cost when a model is wrong, which is exactly the discipline good safety work demands.",
  "Bachelor of Business Administration": "As a Bachelor of Business Administration student building management and analyst skills with an equity, diversity, and inclusion perspective, you will lead functions where algorithms now shape hiring, marketing, and lending. BFS218 shows how tools promoted as objective can reproduce racial and gender bias at scale, and how design justice and emerging AI policy such as Canada's proposed Artificial Intelligence and Data Act try to hold that power accountable. The course turns your equity commitment into something concrete: the ability to recognize engineered inequity in business technology and to argue for building it differently.",
  "Business": "As a Business student gaining job-ready skills for entry-level roles, you will use digital tools and automated systems every day without always seeing how they make decisions. BFS218 pulls back that curtain, showing how everyday software sold as neutral can carry discrimination forward as a default rather than a deliberate choice. You will leave able to notice when a business tool is quietly treating customers or workers unequally, which makes you a more thoughtful professional wherever you land.",
  "Business Analytics": "As a Business Analytics student learning predictive analytics, statistics, and data management for evidence-based decisions, you are training to build the very systems this course puts under the microscope. BFS218 examines cases like predictive models in colleges that would steer support away from Black students, and the Gender Shades audit that measured commercial facial analysis misclassifying darker-skinned women far more often than lighter-skinned men. The course teaches you to audit your own models the way Joy Buolamwini and Timnit Gebru did: define a fair test, measure the gap, and ask who your definitions leave out before your work ships.",
  "Business - Supply Chain and Operations": "As a Business - Supply Chain and Operations student working with ERP systems, data analytics, and generative AI, you will manage flows of goods, information, and increasingly automated decisions. BFS218 examines how inequality in AI lives not only inside the algorithm but outside it, in who holds the power to build and deploy these systems and in the poorly paid labour that trains them. The course helps you see the people behind the automation you coordinate and to weigh the human cost of efficiency, not just its gains.",
  "Clinical Research": "As a Clinical Research student learning research design, quality assurance, and ethics across the pharmaceutical and medical device sectors, you understand that who is represented in a study shapes what the results can claim. BFS218 extends that concern to health technology, examining algorithmic bias in medical tools and the digital divide that leaves some communities, including Indigenous women in remote areas, with limited access to health resources in the first place. The course strengthens your instinct that ethical research means asking who the data includes, who it excludes, and who bears the consequences.",
  "Early Childhood Education": "As an Early Childhood Education student learning to design inclusive, engaging environments and become a Registered Early Childhood Educator, you build the settings where children first learn they belong. BFS218 examines how technology can undercut that belonging, from biased ed-tech to surveillance and systems that flag or sort children unequally, and how design justice insists the people most affected should lead the design. The course helps you bring a critical eye to the digital tools entering early learning, so inclusion holds even when a screen is involved.",
  "Financial Planning": "As a Financial Planning student preparing to advise clients and pursue certifications like the QAFP and CFP, you will guide people through decisions that banks and insurers increasingly automate. BFS218 shows how algorithmic scoring in lending and insurance can carry old inequities forward under a banner of objectivity, harming people without anyone intending it. The course gives you the awareness to recognize when an automated judgment about a client is unfair, and to advocate for the people the system does not see clearly.",
  ...
  "Financial Technology": "As a Financial Technology student learning product development, distributed ledger technology, and application development for the financial sector, you are building the disruptive tools this course studies. BFS218 shows how fintech promoted as neutral and modern can reproduce racial bias in credit and access, the New Jim Code in new clothing, and how design justice asks builders to center the people a product could harm. The course gives you, as a future builder, the questions to ask before you ship rather than after the damage is measured.",
  "Fire Protection Engineering Technician": "As a Fire Protection Engineering Technician student training for the fire service and the alarm and suppression industry, you are entering emergency response, a field that runs increasingly on dispatch algorithms, sensors, and risk data. BFS218 examines how predictive and surveillance systems in public safety have spread across Canada ahead of clear rules and weigh hardest on racialized communities. The course helps you think about whose safety the data serves and how a supposedly neutral risk model can decide, unequally, where protection goes first.",
  "Fraud Examination and Forensic Accounting": "If the Fraud Examination and Forensic Accounting program returns from its current unavailable status, you would train to investigate fraud and financial irregularities using computer forensics and data mining. BFS218 speaks directly to that work, examining how automated fraud-detection and risk systems can flag people unequally and how surveillance tools outrun the law, as Canada's Privacy Commissioner found with the RCMP's use of Clearview AI. The course would give you the critical lens to use investigative technology without inheriting its hidden biases.",
  ...
  "General Arts - English for Academic Purposes": "As a General Arts English for Academic Purposes student strengthening your writing, reading, and critical thinking for study at an Ontario college, you are building exactly the skills this course puts to work. BFS218 examines how technology sold as neutral can carry bias, including systems that judge language and sort people, and it treats critical thinking as a tool for seeing through those claims. The course helps you read the digital world as carefully as you are learning to read a text.",
  "General Arts - One Year Certificate": "As a General Arts One Year Certificate student exploring pathways and building critical thinking, you are giving yourself room to ask big questions before you specialize. BFS218 offers one worth carrying into any field: how do the algorithms around us decide who gets seen, supported, or sorted out? The course shows how technology promoted as objective can quietly reproduce inequity, and it hands you a lens that stays useful whatever direction you choose next.",
  "Government Relations": "As a Government Relations student learning issue analysis, campaign planning, and stakeholder engagement to shape government action, you will work on exactly the terrain where AI policy is being decided. BFS218 closes on tech accountability and policy futures, examining a critique of Canada's proposed Artificial Intelligence and Data Act that found significant gaps and too little public engagement. The course gives you grounded, specific knowledge of what is at stake when technology outruns its rules, so you can advocate on it with real substance.",
  "Honours Bachelor of Health Administration": "As an Honours Bachelor of Health Administration student building competencies in health informatics, health law, and evidence-informed leadership, you will steward the data systems that run modern care. BFS218 examines algorithmic bias in health technology, the digital divide that limits some communities' access to care, and the principle of Indigenous data sovereignty, the right of Indigenous communities to govern data about themselves. The course helps you lead health systems that stay accountable to the people they are supposed to serve, especially those most often overlooked.",
  "Honours Bachelor of Interdisciplinary Studies": "As an Honours Bachelor of Interdisciplinary Studies student drawing on many fields to build transferable workforce skills, you are well placed to see a pattern that crosses every sector. BFS218 shows how technology sold as objective reproduces inequity in policing, health, education, hiring, and finance alike, and how the response ranges from design justice to AI policy. The course gives you an integrative lens on techno-racism that connects to wherever your interdisciplinary path leads.",
  "Honours Bachelor of Mental Health and Addiction": "As an Honours Bachelor of Mental Health and Addiction student learning trauma-informed, recovery-oriented practice grounded in the social determinants of health, you work with people who are often surveilled, sorted, and underserved by systems. BFS218 examines how algorithmic risk scoring and surveillance can fall hardest on marginalized communities, and how the digital divide shapes who can even reach services. The course deepens your understanding of the structural forces around your clients, so your care accounts for the systems acting on their lives.",
  "Human Resources Management": "As a Human Resources Management student building skills across the HR functions, from talent acquisition to HRIS, you will decide whether and how automated tools screen the people who apply and work at your organization. BFS218 examines how hiring algorithms and facial analysis used in recruitment can reproduce racial and gender bias, and how design justice asks that the people affected help shape the systems that judge them. The course gives you the critical judgment to adopt HR technology responsibly rather than trust a vendor's claim of objectivity.",
  "Human Resources Management (Graduate Certificate)": "As a Human Resources Management student building skills across the HR functions, from talent acquisition to HRIS, you will decide whether and how automated tools screen the people who apply and work at your organization. BFS218 examines how hiring algorithms and facial analysis used in recruitment can reproduce racial and gender bias, and how design justice asks that the people affected help shape the systems that judge them. The course gives you the critical judgment to adopt HR technology responsibly rather than trust a vendor's claim of objectivity.",
  "Immigration Case Management": "As an Immigration Case Management student preparing for administrative work in the immigration field, and mindful that this program does not qualify you to give legal advice or practise as a regulated consultant, you will support files at the sharp edge of border technology. BFS218 draws directly on Petra Molnar's research into digital border technologies, the surveillance, biometrics, and automated decision systems tested on migrants who have the least power to refuse. The course gives you a clear-eyed understanding of the systems your future clients move through and the privacy and ethics questions your role must respect.",
  "Interactive Media Design": "As an Interactive Media Design student learning UX, UI, and interactive and immersive design, you will shape the interfaces through which people meet technology. BFS218 centers design justice, Sasha Costanza-Chock's framework that judges a design by its impact rather than its makers' intentions and puts the communities most affected at the lead of the work. The course also examines the coded gaze, the way image and interface systems can be built around some users and blind to others, so you can design for the people a product might otherwise leave out.",
  "Justice Administration Services": "As a Justice Administration Services student preparing to work as an administrator or clerk in Canadian courts and tribunals, you will operate inside the justice system this course examines closely. BFS218 looks at algorithmic policing in Canada, including predictive policing and facial recognition, and at legal analyses warning that these tools threaten Charter rights and were adopted ahead of clear legislation. The course gives you an informed view of how technology is reshaping justice from the inside, which is valuable in the very institutions you are training to serve.",
  "Justice Administration Services (Articulated)": "As a Justice Administration Services (Articulated) student on the accelerated path into court and tribunal administration, you will enter a justice system increasingly run on algorithms and surveillance data. BFS218 examines predictive policing and facial recognition in Canada, and the argument that these tools were authorized through court rulings rather than legislation, leaving Charter rights exposed. The course equips you to understand the digital systems moving through the institutions you will serve and the rights questions they raise.",
  "Law Clerk": "As a Law Clerk student learning litigation, real estate, corporate, and family law alongside the legal technology those areas require, you will handle the tools and data that increasingly drive legal work. BFS218 examines how algorithmic systems used in policing and the justice system can carry bias and threaten Charter rights, and how oversight has struggled to keep pace. The course gives you a critical awareness of legal technology that complements your practical training and serves the clients whose cases you help manage.",
  "Law Clerk (Accelerated)": "As a Law Clerk (Accelerated) student covering criminal, immigration, and other practice areas at pace, you will support cases that often intersect with surveillance and automated decision systems. BFS218 examines predictive policing, facial recognition, and digital border technologies, and the legal warnings that these tools have outrun clear regulation in Canada. The course adds a grounded understanding of the technology shaping the cases you will work on, from criminal matters to immigration files.",
  "Liberal Arts University Transfer": "As a Liberal Arts University Transfer student studying humanities and social sciences on your way to a bachelor's degree, you are building the critical thinking this course puts to serious use. BFS218 examines how technology promoted as neutral reproduces racial inequity, drawing on critical race theory, intersectionality, and design justice to explain why. The course is exactly the kind of interdisciplinary inquiry that will strengthen your transfer path and your ability to read the society you are studying.",
  "Non-Profit and Social Sector Management": "As a Non-Profit and Social Sector Management student learning to lead organizations across advocacy, social services, and community sectors, you serve communities that algorithmic systems often surveil, sort, or overlook. BFS218 examines the digital divide, algorithmic gatekeeping, and design justice, showing both how technology harms marginalized people and how communities lead the response. The course helps you advocate with your clients rather than only for them, and to weigh the technology your organization adopts against its impact on the people you serve.",
  ...
  "Office Administration - Executive": "As an Office Administration Executive student mastering business procedures, Microsoft Office, and the coordination that keeps an office running, you will operate the digital systems a workplace depends on daily. BFS218 shows how workplace technology sold as neutral, from automated scheduling to monitoring and data tools, can treat people unequally without anyone intending it. The course gives you the awareness to handle office technology and the data it holds with a fairness-minded, privacy-conscious eye.",
  "Office Administration - Health Services": "As an Office Administration Health Services student learning medical terminology, health records, and specialized medical software, you will handle sensitive patient data in busy care settings. BFS218 examines algorithmic bias in health technology, patient privacy, and the digital divide that shapes who can reach care, including remote and Indigenous communities. The course helps you steward health information with an understanding of how these systems can serve some patients better than others, and why privacy matters so much.",
  "Office Administration - Legal": "As an Office Administration Legal student learning legal office procedures, specialized legal software, and the workings of litigation and other practice areas, you will manage confidential files and legal technology. BFS218 examines how algorithmic systems in policing and justice can carry bias and how surveillance tools have outrun privacy law in Canada. The course adds a privacy-aware, critical understanding of legal technology to the practical skills that will make you valuable in a firm or legal department.",
  "Pharmaceutical Regulatory Affairs and Quality Operations": "As a Pharmaceutical Regulatory Affairs and Quality Operations student learning drug legislation, submissions, and good manufacturing practices, you work at the intersection of health products and the rules that govern them. BFS218 examines algorithmic bias in medical technology, whose data these systems are built on, and the wider question of how AI should be regulated, drawing on a critique of Canada's proposed Artificial Intelligence and Data Act. The course strengthens your regulatory instinct that oversight must ask who a technology includes, who it excludes, and who is accountable when it fails.",
  "Police Foundations": "As a Police Foundations student preparing for careers in policing, enforcement, and community safety, you are entering the field this course examines most directly. BFS218 studies predictive policing, facial recognition, and social-media surveillance in Canada, including the finding that the RCMP's use of Clearview AI was unlawful, and the human-rights argument that these tools threaten Charter rights and weigh hardest on racialized communities. The course gives you, as a future public safety professional, the critical understanding to use these technologies lawfully and fairly rather than take their objectivity on faith.",
  "Project Management - Environmental": "As a Project Management (Environmental) student preparing to manage environmental and civil engineering projects, you will work with GIS, data, and communities affected by what gets built. BFS218 examines design justice and Indigenous data sovereignty, the principle that Indigenous communities have the right to govern data about their lands and people, alongside the broader question of who is counted in the data that drives decisions. The course helps you run projects that stay accountable to the communities they touch, not just to the schedule and the bid.",
  "Public Administration": "As a Public Administration student developing policy analysis and research skills for the public sector, especially Ontario's municipal government, you will help design and deliver services that increasingly rely on automated decisions. BFS218 examines how algorithmic systems in government have been adopted ahead of clear rules and how Canada's proposed Artificial Intelligence and Data Act has been critiqued for significant gaps and too little public engagement. The course gives you the grounding to build public services and policy that hold algorithmic power accountable to the people it affects.",
  "Public Relations - Corporate Communications": "As a Public Relations Corporate Communications student learning media relations, strategic communications, and digital and social media, you will shape how organizations tell their story, including their technology story. BFS218 examines technological benevolence, the way harmful systems can present themselves as progress, and social-media surveillance, giving you a sharp read on the claims companies make about their tools. The course prepares you to communicate honestly about technology and to recognize when a message of objectivity is covering something the public should question.",
  "Real Property Administration (Assessment and Appraisal)": "As a Real Property Administration student learning property valuation, assessment systems, and tax administration with industry technology, you will work with data models that decide what people's property is worth. BFS218 examines how automated systems sold as neutral can carry historical inequity forward, a pattern with a long history in housing and property, and how default discrimination arrives without anyone intending it. The course gives you the awareness to question the assumptions inside valuation and assessment tools rather than treat their outputs as simply objective.",
  "Real Property Administration (Assessment and Appraisal) (Accelerated)": "As a Real Property Administration (Accelerated) student building expertise in valuation, assessment, and property tax at an intensive pace, you will rely on data-driven systems to value property fairly. BFS218 shows how automated tools presented as objective can reproduce inequity built into their data, especially in housing and property, where that history runs deep. The course helps you read the design and data behind valuation technology critically, so fairness is something you check rather than assume.",
  "Sports, Entertainment and Event Marketing": "As a Sports, Entertainment and Event Marketing student learning brand management, sponsorship, and data-driven event marketing, you will use audience data and increasingly biometric technology at venues and events. BFS218 examines facial recognition and its measured tendency to misread darker-skinned faces, along with algorithmic targeting and surveillance, so you can weigh the ethics of the tools deployed on fans and crowds. The course helps you market experiences without treating the people in the stadium as data to be surveilled unequally.",
  "Sports, Entertainment and Event Marketing (Graduate Certificate)": "As a Sports, Entertainment and Event Marketing student learning brand management, sponsorship, and data-driven event marketing, you will use audience data and increasingly biometric technology at venues and events. BFS218 examines facial recognition and its measured tendency to misread darker-skinned faces, along with algorithmic targeting and surveillance, so you can weigh the ethics of the tools deployed on fans and crowds. The course helps you market experiences without treating the people in the stadium as data to be surveilled unequally.",
  "Sustainable Urban and Transportation Planning": "As a Sustainable Urban and Transportation Planning student integrating equity and inclusion into your work, using GIS, and planning for Indigenous communities, you are already working where digital justice and the built environment meet. BFS218 examines smart-city surveillance, whose data drives planning decisions, and Indigenous data sovereignty, the right of Indigenous communities to govern data about themselves, along with design justice as a way to center affected communities. The course reinforces the equitable, inclusive planning your program is built around, extending it to the algorithms shaping cities.",
  "Technical Communication": "If the Technical Communication program returns from its current unavailable status, you would train in technical writing, UX, content strategy, and AI technologies to make complex systems clear to users. BFS218 speaks to that mission, examining how transparency about how AI systems work is a condition for catching hidden harm, and how design justice puts affected communities at the center of what gets built and documented. The course would give you a justice-minded reason to make technology legible, not just usable.",
  "Technical Communication (Graduate Certificate)": "If the Technical Communication program returns from its current unavailable status, you would train in technical writing, UX, content strategy, and AI technologies to make complex systems clear to users. BFS218 speaks to that mission, examining how transparency about how AI systems work is a condition for catching hidden harm, and how design justice puts affected communities at the center of what gets built and documented. The course would give you a justice-minded reason to make technology legible, not just usable.",
  "Tourism - Services Management - Travel Services Specialization": "As a Tourism (Travel Services) student learning global distribution systems, tourism geography, and the corporate and leisure travel sectors, you will move people across borders that run on surveillance technology. BFS218 examines digital border technologies and facial recognition, including biometric screening tested first on those with the least power to refuse and shown to misread darker-skinned faces more often. The course helps you understand the systems your travelers pass through and the unequal ways those systems can treat them.",
  "Tourism - Travel Operations": "As a Tourism (Travel Operations) student mastering reservations, ticketing, and global distribution systems like Sabre and Amadeus, you will work in an industry threaded with biometric screening and passenger surveillance. BFS218 examines facial recognition and digital border technologies, and the pattern of these tools being deployed on the least protected travelers before the rules catch up. The course gives you a grounded sense of the surveillance systems surrounding travel and how they sort passengers unequally.",
  "Visual Effects for Film and Television": "If the Visual Effects for Film and Television program returns from its current unavailable status, you would train in Houdini, Maya, and Nuke to build compositing, lighting, and digital imagery for the screen. BFS218 examines the coded gaze, the way image and camera technologies can be calibrated around some skin tones and not others, and the facial-analysis systems that misread darker-skinned faces far more often than lighter ones. The course would give you, as a future image-maker, a critical awareness of how visual technology sees, and fails to see, different people.",
