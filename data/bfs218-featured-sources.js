...
(function () {
  ...
  var sources = [
    ...
    {
      id: 'cbcjustice2025', assigned: 'Optional audio case for Week 5', eye: 'western', type: 'Recorded lecture and article', access: 'open',
      ...
      themes: ['facial recognition','intersectionality','algorithmic justice'], origin: 'Canada', len: '53:59 radio program and article', diff: 1,
      abstract: 'CBC Ideas presents Joy Buolamwini’s February 2025 Rubenstein Lecture at Duke University, with a written excerpt published on May 12, 2025. She connects experiences of face-detection and classification bias with wider concerns about discrimination, surveillance, exploitation, and algorithmic justice. Distinguish the research findings from the broader argument for accountability.',
  ...
  MC.cbcjustice2025 = [
    { q: 'What does algorithmic justice add after a disparity is measured?', options: ['A claim that measurement is enough', 'Questions about rights, safeguards, accountability, and power', 'A promise that every error can be removed', 'A reason to ignore intersectionality'], answer: 1, why: 'The lecture moves from documenting bias toward what institutions and public rules should change.', skill: 'concepts', diff: 1 },
    { q: 'Why does Week 5 pair this lecture with Gender Shades?', options: ['The lecture replaces the research evidence', 'The study supplies measured evidence while the lecture helps students consider public response and accountability', 'They make identical claims in identical formats', 'The lecture is older than the study'], answer: 1, why: 'The two sources do different jobs: one documents a disparity and the other extends the discussion toward justice and accountability.', skill: 'sources', diff: 2 }
  ];
  MC.rcigpt4o2024 = [
  ...
  var curated = {
    ...
    'buolamwini2018|cbcjustice2025': 'Gender Shades supplies the empirical foundation for this pairing: Buolamwini and Gebru use an intersectional benchmark to document large accuracy gaps in commercial gender classification. The 2025 CBC Ideas lecture lets Joy Buolamwini reflect on what should follow from evidence like that, including rights, safeguards, public accountability, and algorithmic justice. The study measures the disparity; the lecture discusses its public meaning and the need for action. Students should not use the lecture in place of the study. Instead, compare how a scholarly audit establishes a claim with how a public lecture carries that claim into a justice argument.',
    'attard2023|cbcjustice2025': 'Joy Buolamwini\'s CBC Ideas lecture argues that documented AI bias requires algorithmic justice, not only better accuracy. Attard-Frost tests Canada\'s proposed Artificial Intelligence and Data Act and identifies gaps in specificity, transparency, and public engagement. The lecture makes the justice demand public and accessible; the policy brief asks whether a proposed Canadian law can meet that demand. Read together, they connect evidence of unequal treatment to the concrete rules, oversight, and participation needed for accountability.',
